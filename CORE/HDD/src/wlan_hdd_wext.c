...
#define WE_ENABLE_STRICT_FCC_REG  12
#define WE_SET_MAX_TX_POWER_2_4   13
#define WE_SET_MAX_TX_POWER_5_0   14

/* Private IOCTL for debug connection issues */
#define WE_SET_DEBUG_LOG     15
...
#define WLAN_SET_ROAM_TRIGGER        (SIOCIWFIRSTPRIV + 28) //IKCBS-7767, a22977, Motorola
...
//IKCBS-7767, a22977, Motorola changes -- BEGIN
                            ...
                            union iwreq_data *wrqu, char *extra)
{
   ...
   pCommand = (char*)mem_alloc_copy_from_user_helper(wrqu->data.pointer,
                                              wrqu->data.length);
...
//IKCBS-7767, a22977, Motorola changes -- END
/*
...
static const iw_handler we_private[] = {
   ...
   [WLAN_SET_ROAM_TRIGGER               - SIOCIWFIRSTPRIV]   = iw_set_roam_trigger, //IKCBS-7767, a22977, Motorola
